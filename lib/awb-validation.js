/**
 * AWB Validation Module
 * ตรวจสอบรูปแบบเลขพัสดุ (AWB) ก่อนบันทึกเข้าระบบ
 * 
 * Supported prefixes:
 *  - 864  (Flash Express)
 *  - 7    (TikTok / J&T Express)
...
/**
 * Get the list of valid prefixes (for display in UI)
 */
export function getValidPrefixes() {
  return [...VALID_PREFIXES];
}

export { VALID_PREFIXES, MIN_AWB_LENGTH };
